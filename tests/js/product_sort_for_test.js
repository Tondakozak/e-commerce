...
SortProducts.prototype.addProduct = function(data) {
    this.products.data.push(data);
};

SortProducts.prototype.getFirst = function () {
    return this.products.data[0];
}

SortProducts.prototype.getLast = function() {
    return this.products.data[this.products.data.length-1];
}
